...
if (isset($_POST['add'])) {
	...
	$sql = "insert into property (title,pcontent,type,stype,bedroom,bathroom,balcony,kitchen,hall,size,price,location,city,state,feature,pimage,pimage1,pimage2,pimage3,pimage4,uid,status,mapimage,topmapimage,groundmapimage,totalfloor)
	values('$title','$content','$ptype','$stype','$bed','$bath','$balc','$kitc','$hall','$asize','$price',
							...
							<div class="description">
								...
								<div class="row">
									<div class="col-xl-6">
										...
										<div class="form-group row">
											<label class="col-lg-3 col-form-label" style="margin-bottom:0px !important">Basement Floor Plan
												Image</label>
											<div class="col-lg-9">
									...
									<div class="col-xl-6">
										...
										<div class="form-group row">
											<label class="col-lg-3 col-form-label" style="margin-bottom: 0px !important">Floor Plan
												Image</label>
											<div class="col-lg-9">

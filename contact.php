  ...
  <div id="page-wrapper">
    <div class="row">
      ...
      <div class="full-row">
        <div class="container">
          <div class="row">
            <div class="col-lg-4 mb-5 bg-secondary" style="height:530px !important">
                ...
                <ul>
                  <li class="d-flex mb-4"> <i class="fas fa-map-marker-alt text-white mr-2 font-13 mt-1"></i>
                    <div class="contact-address">
                      ...
                      <span class="text-white">Tongi,Gazipur,Bangladesh</span> <br>
                      <span class="text-white">Dhanmondi,Dhaka,Bangladesh</span><br>
                      <span class="text-white">Mirpur,Dhaka,Bangladesh</span>
                    </div>
                  </li>
                  <li class="d-flex mb-4"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>
                    <div class="contact-address">
                      <h5 class="text-white">Call Us</h5>
                      <span class="d-table text-white">+8801938304286</span>
                      <span class="text-white">+8801956738737</span>
                      <span class="text-white">+8801836456758</span>
                    </div>
                  </li>
                  <li class="d-flex mb-4"> <i class="fas fa-envelope text-white mr-2 font-13 mt-1"></i>
                    <div class="contact-address">
                      <h5 class="text-white">Email Adderss</h5>
                      <span class="d-table text-white">mdkamrulhasantanbir0001@gmail.com</span>
                      <span class="text-white">mdkamrulhasantanbir0002@gmail.com</span>
                      <span class="text-white">mdkamrulhasantanbir0003@gmail.com</span>
                    </div>
                  </li>
                </ul>
              </div>
                    ...
                    <form class="w-100" action="#" method="post">
                      <div class="row">
                        ...
                        <div style="width:100%; display:flex; justify-content:center">
                          <button type="submit" style="border-radius:10px" value="send message" name="send"

        ...
        <div class="container">
          <div class="row">
            ...
            ?>
              ...
              <div class="col-lg-8" style="margin:0px auto !important">

                <div class="row">
                  <div class="col-md-12">
                    <div id="single-property" style="width:1200px; height:700px; margin:30px auto 50px;">
                      <!-- Slide 1-->
                      <div class="ls-slide" style="width:100%; height:100%"
                        data-ls="duration:7500; transition2d:5; kenburnszoom:in; kenburnsscale:1.2;">
                        <img style="object-fit:cover !important" style="width:100%; height:100%"
                      ...
                      <!-- Slide 3-->
                      <div style="object-fit:cover !important" class="ls-slide" style="width:100%; height:100%"
                        data-ls="duration:7500; transition2d:5; kenburnszoom:in; kenburnsscale:1.2;">
                        <img style="width:100%; height:100%" src="admin/property/<?php echo $row['20']; ?>" class="ls-bg"
                          alt="" />
                      </div>
                      ...
                      <div style="object-fit:cover !important" class="ls-slide" style="width:100%; height:100%"
                        data-ls="duration:7500; transition2d:5; kenburnszoom:in; kenburnsscale:1.2;">
                        <img style="width:100%; height:100%" src="admin/property/<?php echo $row['21']; ?>" class="ls-bg"
                          alt="" />
                      </div>
                      ...
                      <div style="object-fit:cover !important" class="ls-slide" style="width:100%; height:100%"
                        data-ls="duration:7500; transition2d:5; kenburnszoom:in; kenburnsscale:1.2;">
                        <img style="width:100%; height:100%" src="admin/property/<?php echo $row['22']; ?>" class="ls-bg"
                          alt="" />
                      </div>
                    </div>
                  </div>
                ...
                <div class="property-details">
                  <div class="bg-gray property-quantity px-4 pt-4 w-100">
                    <ul
                      style="display:flex !important; flex-wrap:wrap !important; width:100% !important ; justify-content:space-around !important ">

      ...
      <div class="row">
        <div class="col-md-8">
          <ul class="top-contact list-text-white  d-table">
            <li><a href="#"><i class="fas fa-phone-alt text-success mr-1"></i>+8801938304286</a></li>
            <li><a href="#"><i class="fas fa-envelope text-success mr-1"></i>mdkamrulhasantanbir0001@gmail.com</a></li>
          </ul>
        </div>
        <div class="col-md-4">
      ...
      <div class="row">
        <div class="col-lg-12">
          <nav class="navbar navbar-expand-lg navbar-light p-0"> <a class="navbar-brand position-relative"
              href="index.php"><img class="nav-logo" src="images/logo/restatelg.png" alt=""></a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              ...
              <a class="btn btn-success d-none d-xl-block" style="border-radius:30px;" href="submitproperty.php">Submit
                Peoperty</a>
            </div>
          </nav>
        </div>

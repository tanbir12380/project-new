...
<body>
    ...
    <div id="page-wrapper">
                                ...
                                <form method="post" action="propertygrid.php">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 col-lg-2">
                                            <div class="form-group">
                                                <button style="border-radius:4px !important" type="submit" name="filter"
		...
		======================================================-->
            ...
            <!--	Recent Properties  -->
            <div class="full-row">
                <div style="width:80% !important ; margin:20px auto !important">
                    <div class="row"
                        style=" display:flex; width:100% !important ; margin:0px auto !important; justify-content:center !important">
                        <div class="col-md-12">
                            ...
                            <div class="tab-content mt-4" id="pills-tabContent">
                                <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home">
                                    <div class="row">
                                        ...
                                        <?php $query = mysqli_query($con, "SELECT property.*, user.uname,user.utype,user.uimage FROM `property`,`user` WHERE property.uid=user.uid ORDER BY date DESC LIMIT 3");
                                        ...
                                        ?>
                                            ...
                                            <div class="col-md-6 col-lg-4">
                                                ...
                                                <div class="featured-thumb hover-zoomer mb-4"
                                                    style="box-shadow: 0 4px 15px rgba(0, 0, 0, 0.2) !important;">
                                                    <div class="overlay-black overflow-hidden position-relative" style="height:300px">
                                                    ...
                                                    <div class="featured-thumb-data shadow-one"
                                                        style="height: 290px !important; overflow-y:scroll !important">
                                                        <div class="p-3">
                                ...
                                <ul>
                                    <li class="mb-4 text-white d-flex">
                                        ...
                                        <div class="pl-2">
                                            ...
                                            <p>This is a dummy text for filling out spaces. This is just a dummy text for filling out blank
                                                spaces.</p>
                                        </div>
                                    </li>
                                    <li class="mb-4 text-white d-flex">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="icon-thumb-one text-center mb-5">
                                ...
                                <div class="left-arrow"><i class="flaticon-investor flat-medium icon-success" aria-hidden="true"></i>
                                </div>
                        ...
                        <div class="col-md-4">
                            <div class="icon-thumb-one text-center mb-5">
                                ...
                                <div class="left-arrow"><i class="flaticon-search flat-medium icon-success" aria-hidden="true"></i>
                                </div>

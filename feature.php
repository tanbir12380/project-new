                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    <td>
                                        ...
                                        <div class="property-info d-table">
                                            ...
                                            <span class="font-14 text-capitalize"><i
                                                    class="fas fa-map-marker-alt text-success font-13"></i>&nbsp; <?php echo $row['14']; ?></span>
                                    ...
                                    <td><a class="btn btn-danger" href="submitpropertydelete.php?id=<?php echo $row['0']; ?>">Delete</a>
                                    </td>
                                </tr>
                            <?php } ?>

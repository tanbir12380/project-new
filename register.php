...
-->
  ...
  <div id="page-wrapper">
    <div class="row">
      ...
      <div class="page-wrappers login-body full-row bg-gray" style="padding-top: 0px !important">
        <div class="login-wrapper">
          <div class="container">
            <div class="loginbox" style="margin-top:0px !important">
              <div class="login-right">
                <div class="login-right-wrap">
                  ...
                  <form method="post" enctype="multipart/form-data">
                    ...
                    <div style="text-align:center !important"><button style="border-radius:5px !important"
                        class="btn btn-success" name="reg" value="Register" type="submit">Register</button></div>
